...
import AllMessagesPage from '../pages/dashboard/MessagesPage';
...
import MessageReadPage from '../pages/dashboard/MessageReadPage';
const GlobalRouter = () => {
  return (
    <Routes>
      {/* <Route path='' element /> */}
      <Route element={<Layout />}>
        ...
        <Route path={PATH_PUBLIC.messageReadPage} element={<MessageReadPage />} />
        ...
        <Route element={<AuthGuard roles={adminAccessRoles} />}>
          ...
          <Route path={PATH_DASHBOARD.messages} element={<AllMessagesPage />} />
