...
const UserNameComboBox = <T extends FieldValues>({ usernames, control, name, error }: IProps<T>) => {
  ...
  const usernamesToShow = inputValue ? usernames.filter((q) => q.includes(inputValue)) : usernames;
