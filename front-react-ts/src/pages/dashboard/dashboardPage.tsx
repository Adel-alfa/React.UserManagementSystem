...
const DashboardPage = () => {
    ...
    <div className="mx-auto mt-6 flex justify-center px-4 sm:mt-6 sm:px-6 md:mt-16 lg:mt-10 lg:px-8">
        <div className="text-center ">
            <h1
                className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                ...
                <div className="mt-2">10X faster
                    ...
                    <span className="relative">.NET 9 and React 19.</span>
                    </span>
                </div>
            </h1>
            <p className="mx-auto mt-3 max-w-xl text-lg text-gray-500 sm:mt-5 md:mt-5">
                This application leverages .NET 9, React 19 (TypeScript), and JWT authentication to deliver a robust role-based admin panel—empowering teams to streamline access, manage users, and scale with confidence.
            </p>
