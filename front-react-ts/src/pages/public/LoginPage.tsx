...
import type { ILoginDto } from '../../types/authDto';
  ...
  return (
    <div className='pageTemplate1'>
      ...
      <div className='max-sm:hidden flex-1 min-h-[600px] h-4/5 bg-linear-to-tr from-[#e0dfe2] via-[#dccff1] to-[#a7bbeb] flex flex-col justify-center items-center rounded-l-2xl'>
        <div className='h-3/5 rounded-2xl flex flex-col gap-8 justify-center items-center bg-white/10  border-[#ffffff55] relative p-2'>
          <h1 className='text-4xl font-bold text-[#754eb4]'>Alfa One</h1>
         
           <img src="./images/Login1.png" className='rounded-2xl p-2' />      
